		...
		try {
			...
			return await this.prisma.studentInfo.update({
				...
				data: {
					...
					std_info_phone: staffStudentInfoEditDto.phone,
					std_info_alternative_email: staffStudentInfoEditDto.alternative_email,
					...
					std_info_home_phone: staffStudentInfoEditDto.home_phone,
					...
					std_info_parent_name: staffStudentInfoEditDto.parent_name,
					std_info_parent_relation: staffStudentInfoEditDto.parent_relation,
					std_info_parent_phone: staffStudentInfoEditDto.parent_phone,
					std_info_food_prefer: staffStudentInfoEditDto.food_prefer,
