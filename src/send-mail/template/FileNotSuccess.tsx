		...
		<Tailwind>
			<Body className="bg-white font-koala">
				...
				<Container className="mx-auto py-5 pb-12">
					<Img src={`${baseUrl}/static/koala-logo.png`} width="170" height="50" alt="Koala" className="mx-auto" />
					<Text className="text-[16px] leading-[26px]">Hi {userFirstname},</Text>
					<Text className="text-[16px] leading-[26px]">Welcome to Koala, the sales intelligence platform that helps you uncover qualified leads and close deals faster.</Text>
